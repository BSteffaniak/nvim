...
vim.keymap.set("n", "<Leader>O", "O<Esc>", key_opts)
vim.keymap.set("n", "<Leader>e", ":GFiles<Enter>", key_opts)
vim.keymap.set("n", "<Leader><Leader>", ":Files<Enter>", key_opts)
vim.keymap.set("n", "<Leader>t", ":NvimTreeToggle<Enter>", key_opts)
vim.keymap.set("n", "<Leader>g", ":NvimTreeFindFile<Enter>", key_opts)
vim.keymap.set("n", "<Leader>c", ":NvimTreeCollapse<Enter>", key_opts)
vim.keymap.set("n", "<Leader>f", ":Rg<Enter>", key_opts)
vim.keymap.set("n", "<Leader>'", ":Rg<Enter>'", key_opts)
vim.keymap.set("n", "<Leader>b", ":Telescope buffers<Enter>", key_opts)
